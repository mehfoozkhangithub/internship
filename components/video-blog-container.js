...
const VideoBlogContainer = ({ playlistId, propTop, propLeft }) => {
  ...
  return (
    <div
      className="w-full max-md:w-[436px] min-[2560px]:w-[614px]   h-full text-center text-mini text-black font-poppins overflow-y-scroll  "
      style={{ top: propTop, left: propLeft }}
    >
      {videos.map((video) => (
